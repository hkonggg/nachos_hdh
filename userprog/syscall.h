...
#define SC_Yield	10
#define SC_Delete   	11
#define SC_ExecProc              12
#define SC_JoinProc              13
#define SC_ExitProc              14
...
#define SC_PrintFloat 51
#define SC_Float_To_Buffer 52
#define SC_FloatCompare 53
#ifndef IN_ASM
...
int floatToBuffer(char* buffer, int number);

int FloatCompare(int a, int b);
